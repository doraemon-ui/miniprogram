...
[json](./playground/pagination/pages/index/index.json ':include :type=code')
...
[wxml](./playground/pagination/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/pagination/pages/index/index.js ':include :type=code')

#### **WXSS**

[wxss](./playground/pagination/pages/index/index.wxss ':include :type=code')
