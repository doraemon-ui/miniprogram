...
[json](./playground/actionsheet/pages/index/index.json ':include :type=code')
...
[wxml](./playground/actionsheet/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/actionsheet/pages/index/index.js ':include :type=code')
