...
[json](./playground/avatar/pages/index/index.json ':include :type=code')
...
[wxml](./playground/avatar/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/avatar/pages/index/index.js ':include :type=code')

#### **WXSS**

[wxss](./playground/avatar/pages/index/index.wxss ':include :type=code')
