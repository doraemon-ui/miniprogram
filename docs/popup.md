...
[json](./playground/popup/pages/index/index.json ':include :type=code')
...
[wxml](./playground/popup/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/popup/pages/index/index.js ':include :type=code')

#### **WXSS**

[wxss](./playground/popup/pages/index/index.wxss ':include :type=code')
