...
[json](./playground/backdrop/pages/index/index.json ':include :type=code')
...
[wxml](./playground/backdrop/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/backdrop/pages/index/index.js ':include :type=code')

#### **WXSS**

[wxss](./playground/backdrop/pages/index/index.wxss ':include :type=code')
