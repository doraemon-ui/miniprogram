...
[json](./playground/animation-group/pages/index/index.json ':include :type=code')
...
[wxml](./playground/animation-group/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/animation-group/pages/index/index.js ':include :type=code')

#### **WXSS**

[wxss](./playground/animation-group/pages/index/index.wxss ':include :type=code')
