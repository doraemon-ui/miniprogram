...
[json](./playground/accordion/pages/index/index.json ':include :type=code')

### 示例代码

[在开发者工具中预览效果](https://developers.weixin.qq.com/s/S0tVr8m97iQD)

<!-- tabs:start -->

#### **WXML**

[wxml](./playground/accordion/pages/index/index.wxml ':include :type=code')

#### **JAVASCRIPT**

[js](./playground/accordion/pages/index/index.js ':include :type=code')

#### **WXSS**

[wxss](./playground/accordion/pages/index/index.wxss ':include :type=code')
