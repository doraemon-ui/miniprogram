...
export default function Index() {
  ...
  return (
    <View className="index">
      <List title="设置" className="list-demo">
        <ListItem isLink openType="chooseAvatar" onChooseAvatar={(e) => console.log('onChooseAvatar====', e)}>
          账户管理
        </ListItem>
        <ListItem title="通知" extra="" isLink>
          <Slot name="footer">
            <View>已开启</View>
          </Slot>
        </ListItem>
      </List>
      <dora-list title="设置" dora-class="list-demo">
        <dora-list-item isLink openType="chooseAvatar" onChooseAvatar={(e) => console.log('onContact11====', e)}>
          账户管理
        </dora-list-item>
        <dora-list-item title="通知" extra="已开启" isLink />
      </dora-list>
      {/* <dora-button expand='block' color='light'>
      Page loaded123
          </dora-button> */}
      <View>Page loaded.</View>
