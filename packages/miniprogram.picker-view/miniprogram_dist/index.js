...
import { getRealCol, getRealValue, getIndexFromValue, getLabelFromIndex } from './utils.js';
...
PickerView = _ts_decorate([
    Component({
        props
    })
], PickerView);
var index = defineComponentHOC()(PickerView);

export { PickerView, index as default };
