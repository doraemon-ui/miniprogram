...
export default class CountUp {
    ...
    rAF = null;
    callback;
    easingFn = (t, b, c, d) => this.easeOutExpo(t, b, c, d);
    formattingFn = (value) => this.formatNumber(value);
    printValue = () => { };
    ...
    mergeOptions(options) {
        ...
        if (typeof merged.easingFn === 'function')
            merged.easingFn = merged.easingFn.bind(this);
        if (typeof merged.formattingFn === 'function')
            merged.formattingFn = merged.formattingFn.bind(this);
        if (typeof merged.printValue === 'function')
            merged.printValue = merged.printValue.bind(this);
        if (merged.separator === '')
            merged.useGrouping = false;
        if (!merged.prefix)
            merged.prefix = '';
        if (!merged.suffix)
            merged.suffix = '';
