...
], Popover.prototype, "hoverClass", void 0);
_ts_decorate([
    Prop({
        type: Object,
        default: null
    })
], Popover.prototype, "wrapStyle", void 0);
Popover = _ts_decorate([
    Component({
        props: {
            prefixCls: {
                type: String,
...
var index = defineComponentHOC()(Popover);
