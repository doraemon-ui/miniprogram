import type { CascaderPickerUtilsFieldNames } from './types'

const DEFAULT_FIELD_NAMES: CascaderPickerUtilsFieldNames = {
  label: 'label',
  value: 'value',
  disabled: 'disabled',
}
...
export function getIndexFromValue(
  ...
  fieldNames: CascaderPickerUtilsFieldNames = DEFAULT_FIELD_NAMES,
) {
